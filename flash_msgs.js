...
async function setFlash(sessionKey,message){
    ...
    return await business.updateSession(sessionKey,sessionData) //You were passing sessionData.data before. I had to change it to sessionData because of the change
